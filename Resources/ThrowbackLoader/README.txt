...
- A "DiscordRichPresence.toml" file is included alongside ThrowbackLoader.
- It is intended for use by an external Discord Rich Presence helper.
- The config describes a presence like:
    Playing Operation Throwback
    [SeasonName] [YearAndSeasonKey]
    Logged in as [NameInThrowbackLoader.toml]
- Your helper should read the username from ThrowbackLoader.toml and replace the placeholders above.